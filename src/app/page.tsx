...
export default function Dashboard() {
      ...
      .on(
        ...
        async (payload) => {
          ...
          if (newMsg.conversation_id === selectedId) {
            ...
            // Operator is looking at this thread, so don't let it show unread.
  ...
  }, [selectedId, fetchConversations, markRead, supabase]);
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between gap-2 mt-0.5">
                      ...
                      <span className="flex items-center gap-1.5 flex-shrink-0">
                        {convo.mode === "human" && convo.unread_count > 0 && (
                          <span className="min-w-[18px] h-[18px] px-1 rounded-full bg-amber-500 text-[10px] font-semibold text-black flex items-center justify-center">
